...
repository](https://github.ibm.com/IBMDigital/ConversationalBanking/).

A good way to familiarize yourself with the codebase and contribution process is
to look for and tackle low-hanging fruit in the [issue
tracker](https://github.ibm.com/IBMDigital/ConversationalBanking/issues). Before embarking on
...
issue](https://github.ibm.com/IBMDigital/ConversationalBanking/issues) before sending a pull
